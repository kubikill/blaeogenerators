$(document).ready(function () {
  ...
  function updPreview() {
    ...
    updBars();
    // Bar
    preview.innerHTML = '<div ' + reviewCode2Bar + 'style="font-family: Oswald, Arial, sans-serif; line-height: 1; font-weight: 500; box-sizing: border-box; position: relative; min-height: 69px;' + bgCode + '; text-shadow: 1px 1px 0 black; ' + barCode + '; ' + reviewPointer + '"><div style="float: ' + vImagePos + ';"><a href="https://store.steampowered.com/app/' + vAppID + '/" target="_blank"><img src="https://steamcdn-a.akamaihd.net/steam/apps/' + vAppID + '/capsule_184x69.jpg" /></a></div><div style="padding-left: 1rem; ' + useMargin + ' width: calc(100% - 184px);"><h2 style="margin-bottom: 0; padding-top: 5px; font-size: 22px; color: ' + vTitleColor + '">' + vGameTitle + vScreenshot + '</h2><p style="margin-bottom: 0; padding-bottom: 6px; font-size: 11px; font-family: Arimo; line-height: 1.4; color: ' + vTextColor + '">' + vPlaytime + ' hours, ' + achievementCode + '<br>' + vCustomText + '</p></div> ' + reviewCodeButton + '</div>' + reviewCodeBar + '<br>';
    viewCodeElement.textContent = '<div ' + reviewCode2Bar + 'style="position: relative; min-height: 69px; ' + bgCode + '; text-shadow: 1px 1px 0 black; ' + reviewPointer + barCode + ';">' + lb + '<div style="float: ' + vImagePos + ';">' + lb + '<a href="https://store.steampowered.com/app/' + vAppID + '/" target="_blank"><img src="https://steamcdn-a.akamaihd.net/steam/apps/' + vAppID + '/capsule_184x69.jpg" /></a>' + lb + '</div>' + lb + '<div style="padding-left: 1rem; ' + useMargin + ' width: calc(100% - 184px);">' + lb + '<h2 style="margin-bottom: 0px; padding-top: 5px; color: ' + vTitleColor + '">' + vGameTitle + vScreenshot + '</h2>' + lb + '<p style="margin-bottom: 0; padding-bottom: 6px; font-size: 1rem; color: ' + vTextColor + '">' + vPlaytime + ' hours, ' + achievementCode + '<br>' + vCustomText + '</p>' + lb + '</div> ' + lb + reviewCodeButton + '</div>' + lb + reviewCodeBar + '<br>';
    // Game box
    boxPreview.innerHTML = '<ul class="games"><li class="game-thumbnail game game-' + boxBarColor + '"><div class="title">' + vGameTitle + '</div><a href="https://store.steampowered.com/app/' + vAppID + '/" target="_blank"><img alt="' + vGameTitle + '" src="https://steamcdn-a.akamaihd.net/steam/apps/' + vAppID + '/capsule_184x69.jpg"></a><div class="caption"><p>' + vPlaytime + ' hours playtime</p><p>' + achievementCodeBox + '</p></div></li></ul>';
    boxViewCodeElement.textContent = '<li class="game-thumbnail game game-' + boxBarColor + '">' + lb + '<div class="title">' + vGameTitle + '</div>' + lb + '<a href="https://store.steampowered.com/app/' + vAppID + '/" target="_blank"><img alt="' + vGameTitle + '" src="https://steamcdn-a.akamaihd.net/steam/apps/' + vAppID + '/capsule_184x69.jpg"></a>' + lb + '<div class="caption">' + lb + '<p>' + vPlaytime + ' hours playtime</p><p>' + achievementCodeBox + '</p>' + lb + '</div>' + lb + '</li>';
    // Panel
