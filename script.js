window.onload=function(){
  ...
  function updBars(){
    if (vBarType == "none") {
      ...
      barCode = "border-left: 10px solid " + vBarColor1;
      barTwoCode = '<div style="border-left: 10px solid ' + vBarColor2 + '; margin-left: -6px; min-height: 70px;">';
